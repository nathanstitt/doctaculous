...
func TestTodocxCmdHTMLInput(t *testing.T) {
	...
	doc, err := omnidoc.OpenDOCX(out)
	if err != nil {
		t.Fatalf("produced docx does not open: %v", err)
	}
	var sb strings.Builder
	if err := doc.WriteText(t.Context(), &sb, omnidoc.MarkdownOptions{}); err != nil {
...
func TestConvertCmdDocxOutput(t *testing.T) {
	...
	var sb strings.Builder
	if err := doc.WriteMarkdown(t.Context(), &sb, omnidoc.MarkdownOptions{}); err != nil {
